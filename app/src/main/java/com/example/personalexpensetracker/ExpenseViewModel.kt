...
//    val categoryExpenseLiveData = MutableLiveData<List<Expense>>()
//
//    fun loadCategoryExpenses() {
//        categoryExpenseLiveData.value = repository.getCategoryWiseExpense()
//    }
...
//    fun getTotalExpensesLiveData() = repository.getTotalExpenses(getCurrentUserId()).asLiveData()
//    fun getTotalExpensesWithFixed() = repository.getTotalExpenses(getCurrentUserId())
//        .map { dbTotal ->
//            val fixedExpense = PrefsHelper.getFixedExpense(context)
//            (dbTotal ?: 0.0) + fixedExpense
//        }.asLiveData()
